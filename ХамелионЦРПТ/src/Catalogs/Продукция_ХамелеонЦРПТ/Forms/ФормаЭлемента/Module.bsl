...
Процедура ОбновляемВсеДанныеНаСервере(NNN)  Экспорт
	...
	ИначеЕсли Объект.Тип=Перечисления.ТипПродукции_ХамелеонЦРПТ.Молоко Тогда
		...
		ДополнителныеРеквизитМолоко.ВариантыСостава.Очистить();
	...
	Для Каждого Стр_1 Из NNN.attrGroup Цикл
						Если Стр_1.name="Наименование товара и идентификация" Тогда
							Для Каждого Стр_2 Из Стр_1.attributes Цикл
								Если Стр_2.name="Полное наименование товара" Тогда
									...
									//КонецЕсли;
								ИначеЕсли Стр_2.name="Заявленный объём / вес нетто" Тогда
						...
						ИначеЕсли Стр_1.name="Потребительские свойства" Тогда
							...
							Для Каждого Стр_2 Из Стр_1.attributes Цикл
								...
								ИначеЕсли  Стр_2.name="Специализированная пищевая продукция" Тогда
									
									
									
										ДопРеквизитСюдаЗаписывать.СпециализированнаяПищеваяПродкция=Неопределено;
										Если ЗначениеЗаполнено(Стр_2.value) Тогда
											ДопРеквизитСюдаЗаписывать.СпециализированнаяПищеваяПродкция=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.НайтиПоНаименованию(Стр_2.value,Истина);
											Если Не ЗначениеЗаполнено(ДопРеквизитСюдаЗаписывать.СпециализированнаяПищеваяПродкция) тогда
												СпрГ=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.СоздатьЭлемент();
												СпрГ.Наименование=Стр_2.value;
												СпрГ.Записать();
												ДопРеквизитСюдаЗаписывать.СпециализированнаяПищеваяПродкция=СпрГ.Ссылка;
											Конецесли;
								...
								ИначеЕсли Стр_2.name="Наличие витаминов и минеральных веществ" Тогда
										ДопРеквизитСюдаЗаписывать.НаличиеВитаминовИМинеральныхВеществ=Неопределено;
										Если ЗначениеЗаполнено(Стр_2.value) Тогда
											ДопРеквизитСюдаЗаписывать.НаличиеВитаминовИМинеральныхВеществ=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.НайтиПоНаименованию(Стр_2.value,Истина);
											Если Не ЗначениеЗаполнено(ДопРеквизитСюдаЗаписывать.НаличиеВитаминовИМинеральныхВеществ) тогда
												СпрГ=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.СоздатьЭлемент();
												СпрГ.Наименование=Стр_2.value;
												СпрГ.Записать();
												ДопРеквизитСюдаЗаписывать.НаличиеВитаминовИМинеральныхВеществ=СпрГ.Ссылка;
											Конецесли;
											
										КонецЕсли;
										

								ИначеЕсли Стр_2.name="Номер Е-добавки" Тогда
									Если ЗначениеЗаполнено(Стр_2.value) тогда
										
										ДопРеквизитСюдаЗаписывать.НомерEДобавки=Стр_2.value;
									Конецесли;
...
ИначеЕсли Стр_2.name="Размер в метрической системе, мм" тогда
						...
						ИначеЕсли Стр_2.name="Наружный диаметр" Тогда
								...
								ИначеЕсли Стр_2.name="Технология RunFlat" Тогда
										...
										Если ЗначениеЗаполнено(Стр_2.value) Тогда
											ДопРеквизитСюдаЗаписывать.ТехнологияRunFlat=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.НайтиПоНаименованию(Стр_2.value,Истина);
								...
								ИначеЕсли Стр_2.name="Шины с цельнометаллическим кордом" Тогда
										...
										Если ЗначениеЗаполнено(Стр_2.value) Тогда
											ДопРеквизитСюдаЗаписывать.ШинаСЦельнометаллическимКордом=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.НайтиПоНаименованию(Стр_2.value,Истина);
								...
								ИначеЕсли Стр_2.name="Продукция для детского питания" Тогда
									//Если Объект.Тип=Перечисления.ТипПродукции_ХамелеонЦРПТ.ПитьеваяВода Тогда
										...
										Если ЗначениеЗаполнено(Стр_2.value) Тогда
											ДопРеквизитСюдаЗаписывать.ПродукцияДляДетскогоПитания=Справочники.ПродукцияДляДетскогоПитания_МОЛОКО_ХамелеонЦРПТ.НайтиПоНаименованию(Стр_2.value,Истина);
											Если Не ЗначениеЗаполнено(ДопРеквизитСюдаЗаписывать.ПродукцияДляДетскогоПитания) тогда
												СпрГ=Справочники.ПродукцияДляДетскогоПитания_МОЛОКО_ХамелеонЦРПТ.СоздатьЭлемент();
												СпрГ.Наименование=Стр_2.value;
												СпрГ.Записать();
								...
								ИначеЕсли Стр_2.name="Содержит пальмовое масло" Тогда
									...
									ИначеЕсли Стр_2.name="Витаминизация" Тогда
										...
										Если ЗначениеЗаполнено(Стр_2.value) Тогда
											ДопРеквизитСюдаЗаписывать.Витаминизация=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.НайтиПоНаименованию(Стр_2.value,Истина);
						...
						ИначеЕсли Стр_1.name="Состав" Тогда
							...
							Для Каждого Стр_2 Из Стр_1.attributes Цикл
								...
								ИначеЕсли Стр_2.name="Вариант состава" Тогда
									
									
												Добав_1=ДопРеквизитСюдаЗаписывать.ВариантыСостава.Добавить();
												Добав_1.ВариантСостава=Стр_2.value;
						...
						ИначеЕсли Стр_1.name="Эксплуатация и условия хранения" Тогда
							...
							ИначеЕсли Стр_2.name="Срок хранения до 40 суток (включительно)" Тогда
									
										ДопРеквизитСюдаЗаписывать.СрокХраненияДо40СутокВключительно=Неопределено;
										Если ЗначениеЗаполнено(Стр_2.value) Тогда
											ДопРеквизитСюдаЗаписывать.СрокХраненияДо40СутокВключительно=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.НайтиПоНаименованию(Стр_2.value,Истина);
											Если Не ЗначениеЗаполнено(ДопРеквизитСюдаЗаписывать.СрокХраненияДо40СутокВключительно) тогда
												СпрГ=Справочники.ПродукцияДляДетскогоПитания_ХамелеонЦРПТ.СоздатьЭлемент();
												СпрГ.Наименование=Стр_2.value;
												СпрГ.Записать();
												ДопРеквизитСюдаЗаписывать.СрокХраненияДо40СутокВключительно=СпрГ.Ссылка;
											Конецесли;
...
ИначеЕсли Стр_2.name="ХС-производитель" Тогда
	...
	Если НЕ ЗначениеЗаполнено(Объект.МВ_Интегратор) Тогда
		...
		ИнтеграторНаЛинияхПроизводства 		= ЗначенияНастроек;
		Объект.МВ_Интегратор = ИнтеграторНаЛинияхПроизводства ;
	КонецЕсли;
...
&НаКлиенте
Процедура ОбновляемСтруктуруПроудкции(attrGroup,identifier=Неопределено)
	Для Каждого Стр_1 Из attrGroup Цикл
									...
									//Для Каждого Стр_а Из Стр_1.attributes Цикл
										...
										Если  Стр_а.name="Тип материала, %" Тогда
											...
											Иначе
												ДопСроковЕть=Истина;
											КонецЕсли;
										ИначеЕсли  Стр_а.name="Вариант состава" Тогда
											Если ВариантСостава Тогда
												Стр_1.attributes.Удалить(Сч);
												Сч=сч-1;
												//УдалитьСрокДоп.Добавить(Стр_а);
											Иначе
												ВариантСостава=Истина;
											КонецЕсли;
										Конецесли;
										Сч=Сч+1;
									Конеццикла;
						...
						Если identifier<>Неопределено Тогда
							Для Каждого Стр_1 Из identifier Цикл
								...
								ИначеЕсли Стр_1.name="Характеристики товара в состоянии использования" Тогда
									  Для Каждого Стр_а Из Стр_1.attributes Цикл
										Если Стр_а.name="Конструктивная масса, кг" Тогда
											Стр_а.value=ДополнительныйРеквизитВелосипед.КонструктивнаяМасса;
										...
										Если  Стр_а.name="Номер Регламента/стандарта" Тогда
											...
											Если ДополнительныеРеквизитФото.НомерРегламента004=Истина Тогда
												...
												Если Первая Тогда
														...
														Конеццикла;
														Стр_Н.value="ТР ТС 004/2011 ""О безопасности низковольтного оборудования""";
														//Стр_Н.valueType=Строка(Стр_.ТипГОСТТУ) ;
														// Стр_1.attributes.Вставить();
														 МассивНормативово.Добавить(Стр_Н);
												...
												Иначе
												     Первая=Истина;
													    ...
													    Стр_а.value="ТР ТС 004/2011 ""О безопасности низковольтного оборудования""";
		...
		МассивГОСТТУ.Очистить();
							...
							Для Каждого Стр_1 Из attrGroup Цикл
								...
								ИначеЕсли Стр_1.name="Потребительские свойства" Тогда
									Для Каждого Стр_а Из Стр_1.attributes Цикл
										...
										ИначеЕсли  Стр_а.name="Жирность, %" Тогда
											...
											КонецЕсли;
										ИначеЕсли  Стр_а.name="Специализированная пищевая продукция" Тогда
											Если ЗначениеЗаполнено(ДополнителныеРеквизитМолоко.СпециализированнаяПищеваяПродкция) Тогда
												Стр_а.value=Строка(ДополнителныеРеквизитМолоко.СпециализированнаяПищеваяПродкция);
												Стр_а.valueTitle=Строка(ДополнителныеРеквизитМолоко.СпециализированнаяПищеваяПродкция);
												Стр_а.valueType=Неопределено
											КонецЕсли;
										ИначеЕсли  Стр_а.name="Продукция для детского питания" Тогда
										...
										ИначеЕсли  Стр_а.name="Содержит ГМО" Тогда
											Если ЗначениеЗаполнено(ДополнителныеРеквизитМолоко.СодержитГМО) Тогда
												...
												Стр_а.valueType=Неопределено
											КонецЕсли;
										ИначеЕсли Стр_а.name="Наименование пищевой добавки" Тогда
											...
											КонецЕсли;
										ИначеЕсли Стр_а.name="Номер Е-добавки" Тогда
											Если ЗначениеЗаполнено(ДополнителныеРеквизитМолоко.НомерEДобавки) Тогда
												Стр_а.value=Строка(ДополнителныеРеквизитМолоко.НомерEДобавки);;
											КонецЕсли;
										...
										ИначеЕсли Стр_а.name="Заменитель молочного жира" Тогда
											Если ЗначениеЗаполнено(ДополнителныеРеквизитМолоко.ЗаменительМолочногоЖира) Тогда
												...
												Стр_а.valueType=Неопределено
											КонецЕсли;
										ИначеЕсли Стр_а.name="Наличие витаминов и минеральных веществ" Тогда
											Если ЗначениеЗаполнено(ДополнителныеРеквизитМолоко.НаличиеВитаминовИМинеральныхВеществ) Тогда
												Стр_а.value=Строка(ДополнителныеРеквизитМолоко.НаличиеВитаминовИМинеральныхВеществ);
												Стр_а.valueTitle=Строка(ДополнителныеРеквизитМолоко.НаличиеВитаминовИМинеральныхВеществ);
												Стр_а.valueType=Неопределено
											КонецЕсли;
										ИначеЕсли Стр_а.name="Тип сырья / обработки" Тогда
								...
								ИначеЕсли Стр_1.name="Эксплуатация и условия хранения" Тогда
									...
									Для Каждого Стр_а Из Стр_1.attributes Цикл
										Если  Стр_а.name="Срок годности" Тогда
											...
											КонецЕсли;
										ИначеЕсли  Стр_а.name="Срок хранения до 40 суток (включительно)" Тогда
											Если ЗначениеЗаполнено(ДополнителныеРеквизитМолоко.СрокХраненияДо40СутокВключительно) Тогда
												Стр_а.value=Строка(ДополнителныеРеквизитМолоко.СрокХраненияДо40СутокВключительно);
												Стр_а.valueTitle=Строка(ДополнителныеРеквизитМолоко.СрокХраненияДо40СутокВключительно);
												Стр_а.valueType=Неопределено
											КонецЕсли;
										ИначеЕсли  Стр_а.name="Особые условия хранения" Тогда
								...
								ИначеЕсли Стр_1.name="Состав" Тогда
									...
									МассивВариантыСостава=Новый Массив;
									Для Каждого Стр_а Из Стр_1.attributes Цикл
										Если  Стр_а.name="Состав" Тогда
										...
										ИначеЕсли Стр_а.name="Вариант состава" Тогда
											 ...
											 Если ДополнителныеРеквизитМолоко.ВариантыСостава.Количество()>0 Тогда
												
												Первая=ложь;
												Для Каждого Стр_ Из ДополнителныеРеквизитМолоко.ВариантыСостава Цикл
													Если Не Первая Тогда
														Первая=Истина;
														Стр_а.value=Строка(Стр_.ВариантСостава);
													Иначе
														...
														Конеццикла;
														Стр_Н.value=Строка(Стр_.ВариантСостава);;
														МассивВариантыСостава.Добавить(Стр_Н);
									...
									Для Каждого Стр_Ст ИЗ МассивВариантыСостава    Цикл
										Стр_1.attributes.Добавить(Стр_Ст);
									...
									Для Каждого Стр_а Из Стр_1.attributes Цикл
										...
										ИначеЕсли  Стр_а.name="Размер в метрической системе, мм" Тогда
											Если ЗначениеЗаполнено(ДополнительныйРеквизитОбувь.РазмерВМетрическойСистемемм) Тогда
												Стр_а.value=Врег(Строка(ДополнительныйРеквизитОбувь.РазмерВМетрическойСистемемм));
									  ...
									  Для Каждого Стр_а Из Стр_1.attributes Цикл
										...
										ИначеЕсли  Стр_а.name="Глубина изделия" Тогда
											Если ЗначениеЗаполнено(ДополнительныйРеквизитОбувь.ГлубинаЕдиницаИзмерения) Тогда
												...
												Стр_а.valueType=Строка(ДополнительныйРеквизитОбувь.ГлубинаЕдиницаИзмерения)
											КонецЕсли;
										Конецесли;
									Конеццикла
		...
		id=                    NNN.data[0].goods.goodId;
				...
				Иначе
					...
					Попытка
						...
						ОбновляемВсеДанныеНаСервере(NNN_1);
					Исключение
...
Процедура ОбновитьДопРеквизит()
	...
	"ВариантыСостава,Аллергены,ЭнергетическаяЦенность,ДополнительныеСрокиГодности,ГОСТЫИТУ,ПредприятияПроизводители,МассоваяДоляБелка,МассоваяДоляЖира,ИдентификаторыТовараВФГИСМеркурий");
	...
	Для Каждого Стр_1 Из Объект.ДополнительныйРеквизитМолоко.ВариантыСостава Цикл
		Добав=ДополнителныеРеквизитМолоко.ВариантыСостава.Добавить();
		ЗаполнитьЗначенияСвойств(Добав,Стр_1);
	Конеццикла;
...
Процедура ЗапишемДопРеквизиты()
	...
	ДопРе.ВариантыСостава.Очистить();
	Для Каждого Стр ИЗ ДополнителныеРеквизитМолоко.ВариантыСостава Цикл
		
		Добав=ДопРе.ВариантыСостава.Добавить();
		ЗаполнитьЗначенияСвойств(Добав,Стр);
...
Если ПодключилисьОк(Thumbprint_1,crsfToken,Срегистра,Куки,HTTPСервисЗапрос,СерийныйНомер) Тогда
		...
		Если Не ЗначениеЗаполнено(объект.GTIN) тогда
			...
			HTTPЗапрос=Новый HTTPЗапрос("rest/dictionaries/tm?q="+ОбщийМодуль_НаСервере_ХамелеонЦРПТ.КодСтр(Объект.БрендТорговаяМарка));
			HTTPЗапрос.Заголовки.Вставить("Accept","application/json, text/plain, */*");
				HTTPЗапрос.Заголовки.Вставить("Cookie",Куки);
	...
	HTTPЗапрос.Заголовки.Вставить("Authorization","Bearer "+Срегистра);
		...
		ИначеЕсли NNN.data[0].draft=Неопределено Тогда
			...
			///ПЫТАЕМСЯ СОЗДАТЬ ЧЕРНОВИК
						...
						//HTTPЗапрос=Новый HTTPЗапрос("rest/tabs/draft/"+Формат(NNN.data[0].goods.id,"ЧГ="));
		...
		///Возврат;
				...
				//												
						...
						//HTTPЗапрос=Новый HTTPЗапрос("rest/draft/"+Формат(id,"ЧГ="));
						HTTPЗапрос=Новый HTTPЗапрос("rest/tabs/draft/"+Формат(id,"ЧГ="));
						//HTTPЗапрос=Новый HTTPЗапрос("rest/draft/"+Формат(id,"ЧГ="));
						HTTPЗапрос.Заголовки.Вставить("Accept","application/json, text/plain, */*");
						HTTPЗапрос.Заголовки.Вставить("Cookie",Куки);
	HTTPЗапрос.Заголовки.Вставить("Authorization","Bearer "+Срегистра);
			...
			HTTPЗапрос.Заголовки.Вставить("Authorization","Bearer "+Срегистра);
					...
					HTTPЗапрос.Заголовки.Вставить("X-Csrf-Token",crsfToken);
								...
								attrGroup=NNN.attrGroup;
								
								identifier=NNN.identifier;
								
								
								 ОбновляемСтруктуруПроудкции(attrGroup,identifier);				
					...
					Иначе
								...
								Если Объект.Рисунки.Количество()>0 Тогда
									images=Неопределено;
									photosLayer=Неопределено;
									//Если NNN.Свойство("photosLayer",photosLayer)=Ложь Тогда
									//	NNN.Вставить("photosLayer");
									//Конецесли;
									//Если NNN.Свойство("photosLayer",photosLayer) И photosLayer.Свойство("images",images) Тогда
									//	
									//Иначе
									//	images=Новый Массив;
									//	NNN.Вставить("images",images);
									...
									NNN.photosLayer.images.Очистить();
									Для Каждого Стр_1 Из Объект.Рисунки Цикл
										...
										СтруктураИзображения.Вставить("type",ВернутьКод(Стр_1.ТипРисунка));
										СтруктураИзображения.Вставить("url",Стр_1.АдресРисункаURL);
										NNN.photosLayer.images.Добавить(СтруктураИзображения);
									Конеццикла;
								...
								КонецЕсли;
									...
									setGtins=Неопределено;
									Если NNN.businessLayer.Свойство("setGtins",setGtins) Тогда
										ДопСроковЕть=Ложь;
									    Сч=0;
										Пока Сч<NNN.businessLayer.setGtins.Количество() Цикл
											Стр_а=NNN.businessLayer.setGtins[Сч];
												//Если ДопСроковЕть Тогда
													NNN.businessLayer.setGtins.Удалить(Сч);
													Сч=сч-1;
													//УдалитьСрокДоп.Добавить(Стр_а);
												//Иначе
												//	ДопСроковЕть=Истина;
										...
										Для Каждого Стр_22 Из Объект.СоставНабора Цикл
											...
											ГТИН=ВернутьГТИНБезНулей(Стр_22.Продукция);
												...
												//				Иначе
														...
														Для Каждого Стр_Ст ИЗ МассивsetGtins    Цикл
												NNN.businessLayer.setGtins.Добавить(Стр_Ст);
								...
								attrGroup=NNN.markLayer.attrGroup;
								
								
								
								 ОбновляемСтруктуруПроудкции(attrGroup);				
								 
								attrGroup=NNN.businessLayer.attrGroup;
								identifier=NNN.businessLayer.identifier;
...
&НаКлиенте
Процедура ЗарегистрироватьТехническуюКарточку(Команда,УжеОтправили=Ложь) Экспорт
...
&НаКлиенте
Процедура ОбновитьКарточкуПоAPIСуббакаунт(Команда)
	// Вставить содержимое обработчика.
	Форм=ПолучитьФорму("Справочник.Продукция_ХамелеонЦРПТ.Форма.ФормаСписка");
	Форм.ВводГТИН(Формат(Объект.GTIN,"ЧГ="),"");
	ЭтаФорма.Прочитать();
КонецПроцедуры

&НаКлиенте
Процедура ОбновитьИнформациюВетисПоВыделеннойСтроке(Команда)
	// Вставить содержимое обработчика.
	ТекД=Элементы.Таблица6.ТекущиеДанные;
	Если текД<>Неопределено Тогда
		Форм=ПолучитьФорму("Обработка._Запуск_ХамелеонЦРПТ.Форма.Форма");
		Если НЕ Форм.Открыта() Тогда
			Форм.Открыть(); 
		...
		ИДФГИС=текД.ИдентификаторТовараВФГИСМеркурий;
		ОбновитьИнформациюВетисПоВыделеннойСтроке_НаСервере(ИДФГИС,Форм.Пользователь);
	КонецеслИ;
КонецПроцедуры
...
Функция КодироватьПараметры(Тело) Экспорт
	
	Результат = "";
	Для НомСтр = 1 По СтрЧислоСтрок(Тело) Цикл
		Стр = СтрПолучитьСтроку(Тело, НомСтр);
		Раздел = Найти(Стр, ":");
		ДобавитьПараметр(Результат, Лев(Стр, Раздел-1), Сред(Стр, Раздел+1));
	КонецЦикла;
	Возврат Сред(Результат,2);
	
КонецФункции

Процедура ОбновитьИнформациюВетисПоВыделеннойСтроке_НаСервере(ИДФГИС,Пользователь)
		Thumbprint_1=ПолучитьИзПользователя(Пользователь);

		ДополнителныеРеквизитМолоко.ПодлежитВетеринарномуКонтролю=Истина;
		...
		HTTPСервисЗапрос.Open("GET", Сайт+"/operatorui?_action=downloadProductNameList&timestamp="+TimeStamp, 0);
		...
		Текстов.ДобавитьСтроку(HTTPСервисЗапрос.ResponseText);
		Массив_1=Новый Массив;
		
		Для Сч=2 По Текстов.КоличествоСтрок() Цикл
			Массив_1.Очистить();
			Строка=Текстов.ПолучитьСтроку(Сч);
			Пока Значениезаполнено(Строка) Цикл
				Если Найти(Строка,Символы.Таб)>0 Тогда
					КК=Сред(Строка,1,найти(Строка,Символы.Таб)-1);
					Массив_1.Добавить(КК);
					Строка=Сред(Строка,Найти(Строка,Символы.Таб)+1);
				Иначе
					Массив_1.Добавить(Строка);
					Строка="";
				Конецесли;
			
				
			Конеццикла;
			Если Массив_1[12]=ИДФГИС Тогда
				
				ДополнителныеРеквизитМолоко.ТипПродукции=Справочники.ТипПродукции_ХамелеонЦРПТ.НайтиПоНаименованию(Массив_1[4],Истина);
				ДополнителныеРеквизитМолоко.Продукция=Справочники.ПродукцияМолоко_ХамелеонЦРПТ.НайтиПоНаименованию(Массив_1[5],Истина);
				ДополнителныеРеквизитМолоко.ВидПродукции=Справочники.ВидПродукции_ХамелеонЦРПТ.НайтиПоНаименованию(Массив_1[8],Истина);
				ДополнителныеРеквизитМолоко.КатегорияПродукции=Справочники.КатегорияПродукции_ХамелеонЦРПТ.НайтиПоНаименованию("Готовая продукция",Истина);
				
				Если Массив_1.Количество()>=15 Тогда
					ГОСТ=Массив_1[15];
					Если Найти(ГОСТ,"ГОСТ")>0 Тогда
						ДополнителныеРеквизитМолоко.ТипГОСТ=Справочники.ТипГОСТМолоко_ХамелеонЦРПТ.НайтиПоНаименованию("ГОСТ");
					Иначе
						ДополнителныеРеквизитМолоко.ТипГОСТ=Справочники.ТипГОСТМолоко_ХамелеонЦРПТ.НайтиПоНаименованию("---");
					Конецесли;
					Если ЗначениеЗаполненО(ГОСТ) Тогда
						ДополнителныеРеквизитМолоко.ГОСТ=ГОСТ;
					Иначе
						ДополнителныеРеквизитМолоко.ГОСТ="НЕТ СООТВЕТСТВИЯ";
					Конецесли;
				Иначе
		...
		//	НСтр=СтрРазделить(Строка,Символы.Таб);
		...
		//
		//
		//НазваниеПроудкции=Объект.НаименованиеТовара;
		//Продукция_2=Объект.НаименованиеТовара;
		//Если не ЗначениеЗаполненО(НазваниеПроудкции) тогда
		//	НазваниеПроудкции=Объект.Наименование;
		//	Продукция_2=Объект.Наименование;
		//КонецеслИ;
		//Страница=0;
		//Пока Истина Цикл
		//	HTTPСервисЗапрос.Open("POST", Сайт+"/operatorui?_action=listProductItemAjax&_language=ru&filterByFirm=false&firmTemplate=&subProductTemplate=&producing=", 0);
		//	//Обработки._Запуск_ХамелеонМеркурий.УстановитьПрокси(HTTPСервисЗапрос);
		//	HTTPСервисЗапрос.SetRequestHeader("Content-Type","application/x-www-form-urlencoded");
		//	//Заголовки.Вставить("Cookie",Кэш);
		//	//								/operatorui?_action=listVetDocument&_language=ru&pageList=1&all=true&request=true
		//	Если Страница=0 Тогда
		//		Страница_1="";
		//	Иначе
		//		Страница_1=xmlString(Страница);
		//	Конецесли;
		//	Тело_1 ="pageList:"+Страница_1+"
		//	|template:"+Строка(НазваниеПроудкции);
		//	
		////	Если ЗначениеЗаполнено(Продукция_2.Артикул) Тогда
		////	Тело_1 =Тело_1+"
		////	|article:"+Строка(Продукция_2.Артикул);
		////	КонецЕсли;
		//	
		//	HTTPСервисЗапрос.Send(КодироватьПараметры(Тело_1));
		//	HTTPСервисЗапрос.WaitForResponse();
		//
		//	ОтветСтруктура =ОбщийМодуль_НаСервере_ХамелеонЦРПТ.ЗаполнитьСтруктуруИзОтветаJSON(HTTPСервисЗапрос.ResponseText);
		//	Если ОтветСтруктура.results.количество()>0 Тогда
		//		Нашлипозицию=Ложь;
		//		Для Каждого Позитион Из ОтветСтруктура.results Цикл
		//			Если Найти(Позитион.text,Строка(Продукция_2))=1        Тогда
		//				Нашлипозицию=Истина;
		//				Прервать;
		//			Конецесли;
		//			
		//		КонецЦИкла;
		//		Если Не Нашлипозицию Тогда
		//			Если ОтветСтруктура.more=Истина Тогда
		//				Страница=Страница+1;
		//				ПродолжитЬ;
		//			Иначе
		//				Страница=0;
		//			КонецЕсли;
		//		
		//			//Позитион=ОтветСтруктура.results[0];
		//			
		//			Если СтрДлина(НазваниеПроудкции)<=4 Тогда
		//				Прервать;
		//			КонецЕсли;
		//			НазваниеПроудкции=Сред(НазваниеПроудкции,1,СтрДлина(НазваниеПроудкции)/2);
		//			
		//			ПродолжитЬ;
		//		КонецЕсли;							
		//			
...
Процедура ВывестиОтчет(Команда)
	...
	МассивКМ.Добавить(Объект.GTIN);
	
	Форм=ОткрытьФорму("Отчет.ОстаткиПоКМ_ХамелеонЦРПТ.Форма.ФормаОтчета");
	
	
	Форм.ПрименитьОтбор_ГТИН(МассивКМ);

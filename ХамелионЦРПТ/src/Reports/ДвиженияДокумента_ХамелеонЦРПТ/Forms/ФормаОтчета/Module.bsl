...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если НЕ ЗначениеЗаполнено(СпособВыводаОтчета) Тогда
		СпособВыводаОтчета = Перечисления.СпособыВыводаОтчета_ХамелеонЦРПТ.ПоВертикали;
	КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	Если Не ЗначениеЗаполнено(СпособВыводаОтчета) тогда
		СпособВыводаОтчета=ПредопределенноеЗначение("Перечисление.СпособыВыводаОтчета_ХамелеонЦРПТ.ПоВертикали");
	КонецЕсли;
...
Функция ПолучитьДанныеПоДвижениям(МетаданныеРегистра, ВидРегистра)
	...
	//ТекстПоля = " Таблица.НоменклатураЦРПТ.Capacity  КАК ЕМКОСТЬ, ";
				
	//			СтруктураПолей["Измерение"].СтрокаПолей = СтруктураПолей[ИмяКоллекции].СтрокаПолей
	//							+ ?(ПустаяСтрока(СтруктураПолей[ИмяКоллекции].СтрокаПолей),"", ",") + Измерение.Имя;
...
Процедура ВывестиДанныеПоРегистру(МетаданныеРегистра, Макет)
	...
	Если СпособВыводаОтчета = Перечисления.СпособыВыводаОтчета_ХамелеонЦРПТ.ПоГоризонтали Тогда

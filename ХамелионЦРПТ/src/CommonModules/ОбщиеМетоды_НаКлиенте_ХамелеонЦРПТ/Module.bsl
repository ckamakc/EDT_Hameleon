			...
			//	Для Каждого Стр_С ИЗ Стр_С_1.Значение Цикл
				...
				ТипЭмиссии=Стр_С.Значение["emissionType"];
					...
					Если Стр_С.Значение["ownerInn"]<>Thumbprint_1.ИНН Тогда
						...
						Стр_С.Значение["ownerName"],,ВОбороте,ТипЭмиссии));
					ИначеЕсли Стр_С.Значение["statusEx"]="WAIT_SHIPMENT" Тогда
						...
						Стр_С.Значение["lastDocId"],,ВОбороте,ТипЭмиссии));
					Иначе
						МассивСтруктур.Добавить(Новый Структура("cis,статус,ТипУпаковки,ВОбороте,ТипЭмиссии",Стр_С.Ключ,Стр_С.Значение["status"],,ВОбороте,ТипЭмиссии));
					КонецЕсли;
			//	Конеццикла;
			Конеццикла;
		Конецесли;

...
Функция ЧерезФайлДелаем(СформироВатьУПД,Boundary,ИмяВр_1,РазмерФайла,КаталогВременныхФ_1)
	...
	Если ВыгружатьЭДОЛайтЧерезXML Тогда
		...
		Иначе
			...
			//КаталогВременныхФ+	
			   ...
			   ЧереФайл=ЧерезФайлДелаем(СформироВатьУПД,Boundary,СтрокаXML.ИмяФайла,РазмерФайла,КаталогВременныхФ);

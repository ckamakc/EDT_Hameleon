...
Процедура ТоварыGTINПриИзменении(Элемент)
	...
	//++ МВ:Овчинников 20.05.2021  •0
	ТекД = СокрЛП(ТекД);
	//-- МВ:Овчинников 20.05.2021
...
//	Соединение.Send(ЗапрЙосТекст);
	...
	Конеццикла;
		...
		Если СтруктураПВСД.Свойство("Наименование_и_форма_ВСД",Наименование_и_форма_ВСД) И Найти(Наименование_и_форма_ВСД,"Производственный сертификат")>0 Тогда
...
Процедура ТоварыНомерВСДПриИзменении(Элемент)
	// Вставить содержимое обработчика.
	 Текд=Элементы.Товары.ТекущиеДанные.НомерВСД;
	...
	СтруктураВСД=ПолучитьСтруктуруПВСД(НомерВСД);
	Наименование_и_форма_ВСД="";

...
Процедура УправлениеВидимостью(ПоменятьПро=Ложь)
	...
	Иначе
		...
		ИначеЕсли ОБъект.ТипДокумента=Перечисления.ТипыДокументаВводВОборот_ХамелеонЦРПТ.ВыводИзОборота Тогда
			...
			Если Объект.ПричинаВыводаИзОборота=Перечисления.ПричинаВыводаИзОборота_ХамлеонЦРПТ.OTHER Тогда
				Объект.ВидПервичногоДокумента=Перечисления.ТипПервичногоДокумента_ХамелеонЦРПТ.OTHER;
			Конецесли;
			
			Элементы.ПричинаВыводаИзОборота_Строка.Видимость=Объект.ПричинаВыводаИзОборота=Перечисления.ПричинаВыводаИзОборота_ХамлеонЦРПТ.OTHER;

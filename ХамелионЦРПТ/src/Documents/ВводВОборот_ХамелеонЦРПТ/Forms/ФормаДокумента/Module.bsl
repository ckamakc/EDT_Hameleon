...
Объект.Транзакция = НашеОписание.ПривестиЗначение(Объект.Транзакция); 
	...
	//ФТО_РаботаСФормами.ДобавитьКомандуФормы(ЭтаФорма,"ВыбратьВСД","МВ_ВыбратьВСД","Выбрать ВСД",ВидКнопкиФормы.ОбычнаяКнопка, Элементы.Товары.КоманднаяПанель,Элементы.Товары.КоманднаяПанель.ПодчиненныеЭлементы.Подсчитать);

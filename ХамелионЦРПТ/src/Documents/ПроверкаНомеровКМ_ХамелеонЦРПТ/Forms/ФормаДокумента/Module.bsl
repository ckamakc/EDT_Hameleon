...
Процедура ЗаполнитьИнфуПоШтриху(ТипУпаковки)
	...
	Если ПроверкаНаСимволКриллицы И ЕстьКириллица(ДлинныйШтрихкод) тогда
		Сообщить("В строке "+ДлинныйШтрихкод+" присутствует символ кириллицы!!");
		Возврат;
	Конецесли;
...
//	Стр_1.Статус=NNN.status;
	Стр_1.ТипЭмиссии="";
			...
			Для Каждого Стр_С Из NNN Цикл
				...
				Стр_1.ТипЭмиссии=Стр_С.Значение["emissionType"];
	...
	Если Не Значениезаполнено(Стр_1.ТипЭмиссии) Тогда

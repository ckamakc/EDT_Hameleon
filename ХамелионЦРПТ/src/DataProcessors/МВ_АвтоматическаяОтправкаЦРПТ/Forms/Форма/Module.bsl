...
Процедура СохранитьВcsvВыделенныеЗаказы(Команда) Экспорт
	...
	Для Каждого ДокументЗаказМарок Из МассивСсылок Цикл
		...
		GTINСтрока = "";
		ДвоичныеДанные = СохранитьФайлНаДиске(ДокументЗаказМарок, GTINСтрока, Каталог);
		
		Если ДвоичныеДанные <> Неопределено Тогда 
			ИмяФайла = Каталог+"\"+GTINСтрока+".csv";
...
&НаСервереБезКонтекста
Функция СохранитьФайлНаДиске(Ссылка, GTINСтрока, Каталог)
